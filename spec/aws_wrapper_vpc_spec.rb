  ...
  module Ec2
    describe Vpc do
      ...
      it "confirms a VPC named \'#{VPC_NAME}\' doesn\'t exist" do
        expect(AwsWrapper::Ec2::Vpc.exists?(:name => VPC_NAME)).not_to be true
      end
